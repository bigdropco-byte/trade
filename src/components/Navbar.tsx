...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
      ...
      {/* Top Banner / Privacy Bar */}
      <div className="bg-slate-50 border-b border-slate-200 px-3 sm:px-4 py-1 text-xs flex items-center justify-between text-slate-500 gap-2 overflow-x-auto no-scrollbar">
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          <button 
            onClick={onOpenPrivacy}
            className="flex items-center gap-1.5 text-emerald-700 hover:text-emerald-800 transition-colors font-medium cursor-pointer shrink-0"
          >
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="flex items-center gap-1 text-[11px] sm:text-xs text-slate-600 hover:text-slate-900 font-medium transition-colors cursor-pointer mr-1 sm:mr-2"
          ...
          <button
            onClick={onLoadDemo}
            className="flex items-center gap-1 text-[11px] sm:text-xs text-indigo-600 hover:text-indigo-700 font-medium transition-colors cursor-pointer"
          ...
          >
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="text-base sm:text-xl font-extrabold tracking-tight text-slate-900 group-hover:text-emerald-600 transition-colors truncate">
