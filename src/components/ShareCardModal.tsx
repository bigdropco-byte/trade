            ...
            <div className="w-full max-w-sm sm:max-w-md mt-4 bg-white border border-slate-200 rounded-2xl p-4 shadow-xs">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 py-2 px-2.5 bg-slate-900 hover:bg-black text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
                  title="Share performance to X (Twitter)"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 py-2 px-2.5 bg-[#229ED9] hover:bg-[#1b8ec5] text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
                  title="Share to Telegram Channel or Chat"
                >
                  <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 py-2 px-2.5 bg-[#25D366] hover:bg-[#1fad53] text-white rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 py-2 px-2.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 rounded-xl text-xs font-bold transition-all shadow-xs cursor-pointer"
